...
class analysis(object):
    def __init__(self, 
        ...
        self.pv = parameter_values(self.scenario, self.bkg, self.fix_mass, polarization=self.polarization, posterior_combiner=self.posterior_combiner)
        self.file_locations()
    ...
    def set_prior(self):
        self.prior = CustomPrior(self.scenario, self.bkg, fix_mass = self.fix_mass, eos_informed=self.eos_informed, posterior_combiner=self.posterior_combiner)
