...
#SBATCH -t 2-00:00:00
#SBATCH -p genoa
#SBATCH --job-name=ST_smallr_NICERiqu_disk
...
cp $TMPDIR/J1444/ST* $STORAGE_DIR/analysis_files
cp $TMPDIR/parameter_values.py $STORAGE_DIR/analysis_files
cp $TMPDIR/J1444/Custom* $STORAGE_DIR/analysis_files
cp $TMPDIR/J1444/synthesise_data.py $STORAGE_DIR/analysis_files
cp $TMPDIR/J1444/snellius_runs/job* $STORAGE_DIR/analysis_files
cp -r $TMPDIR/J1444/data $STORAGE_DIR/analysis_files
