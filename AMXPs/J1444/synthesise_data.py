...
from CustomInstrument import CustomInstrument_fits
...
################################## INTERSTELLAR ###################################
if machine=='local':
    interstellar = CustomInterstellar.from_SWG("/home/bas/Documents/Projects/x-psi/xpsi-bas-fork/AMXPs/model_data/n_H/TBnew/tbnew0.14.txt", bounds=(0, 100.), value=None)
elif machine=='snellius':
    interstellar = CustomInterstellar.from_SWG("/home/dorsman/xpsi-bas-fork/AMXPs/model_data/interstellar/tbnew/tbnew0.14.txt", bounds=(0, 100.), value=None)
...
_data = SynthesiseData(np.arange(min_detection_channel,max_detection_channel), phases_space, 0, max_detection_channel-min_detection_channel-1)
...
if __name__ == '__main__':
    ...
    cb3 = plt.colorbar(profile, ax=ax2)
    cb3.set_label(label=r'Signal (arbitrary units)', labelpad=25)
    cb3.solids.set_edgecolor('face')
    
    fig2.savefig(f'./plots/signal_{figstring}.png')
