...
# live_points=64
# max_iterations=-1
job_id = 4824358 #4821707 #4814347 #4812696

run_ID = 'run_lp=192_se=0.03_NoDiskBB'
...
ST.runs = xpsi.Runs.load_runs(ID='ST',
                               run_IDs=[run_ID],
                               roots=[f'run_ST_'],
                               base_dirs=[f'/home/bas/Documents/Projects/x-psi/xpsi-bas-fork/AMXPs/J1808_synthetic/snellius_runs/{job_id}/mock1808_lp192'],
