...
class CustomHotRegion(xpsi.HotRegion):
    ...
    #               st, 
    #               energies, 
    #               threads, # here photosphere should also send the disk
    #               hot_atmosphere, 
    #               elsewhere_atmosphere, 
    #               atm_ext_else, 
    #               R_in = 1e6 #1000 km by default will trigger NO blocking
    #               ):
    ...
    #                                        R_in=R_in) # all integrators should be made to handle this keyword param)
