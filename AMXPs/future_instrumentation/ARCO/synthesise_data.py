...
if instrument_string == 'LAD6':
    ...
    instrument = LAD6.from_response_files(
        RMF_file = this_directory+'/../instrument_files/eXTP_LAD_260eV-oar75_v3.rmf',
        ARF_file = this_directory+'/../instrument_files/eXTP_LAD6_260eV-oar75_v3.arf',
    ...
    instrument = TACO.from_response_files(
                    RMF_file = this_directory+'/../instrument_files/TACO_4mod_matrix.txt',
                    ebounds_file = this_directory+'/../instrument_files/TACO_4mod_ebounds.txt',
...
photosphere = CustomPhotosphereDiskLine(hot = hot, disk=disk,
