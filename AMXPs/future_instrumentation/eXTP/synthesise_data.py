...
prior = CustomPrior(scenario, bkg, fix_mass=fix_mass)
...
if __name__ == '__main__':
    ...
    fig.savefig(f'./plots/counts_and_bolometric_extp_{figstring}.png')
    ...
    fig2.savefig(f'./plots/signal_extp_{figstring}_.png')
